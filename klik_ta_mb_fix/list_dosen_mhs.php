                ...
                <?php
                    ...
                    $no = 1;
                      while($data = mysqli_fetch_assoc($sql)){
                        ...
                        echo '<td><a class="btn btn-primary btn-xs" href="#" data-toggle="modal" data-target="#myModal'.$data['id_mhs'].'"><i class="fa fa-eye"></i> Lihat</a></td>';
                                              
                        echo '<td><a class="btn btn-primary btn-xs" href="index.php?page=logbook_bimbingan_dosen&id_mhs='.$id_mhs.'"><i class="fa fa-eye"></i> Lihat</a></td>';

                        echo '<td><a class="btn btn-primary btn-xs" href="index.php?page=riwayat_sidang_mhs&id_mhs='.$id_mhs.'"><i class="fa fa-eye"></i> Lihat</a></td>';
                        ...
                        echo '
                         <!-- Modal -->
                          <div class="modal fade" id="myModal'.$data['id_mhs'].'" role="dialog">
                            <div class="modal-dialog">
                              <!-- Modal content-->
                              <div class="modal-content">
                                <div class="modal-header">
                                  <button type="button" class="close" data-dismiss="modal">&times;</button>
                                  <h4 class="modal-title">Detail Tugas Akhir</h4>
                                </div>
                                <div class="modal-body">
                                 <div class="callout callout-warning">
                                    <h4>Perhatian!</h4>

                                    <p>Selalu ingatkan mahasiswa untuk mengisi logbook</p>
                                  </div>
