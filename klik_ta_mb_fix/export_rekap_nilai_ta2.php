...
<div class="container-fluid ">
  ...
  <p>List Penilaian Bimbingan TA2 <a href="export_to_excel4.php" class="btn btn-info btn-sm" role="button">Export to Excel</a> <a href="index.php?page=rekap_nilai_ta2" class="btn btn-default btn-sm" role="button">Back</a></p>
          ...
          <thead>
                <tr>
                 <th>ID</th>
                  ...
                  <th>Judul</th>
                  <th>Pembimbing</th>
                  <th>Keselarasan dengan rancangan (60%)</th>
                  <th>Tingkat penyelesaian (40%)</th>
                  <th>Progress penelitian mingguan (15%)</th>
                  <th>Kemandirian (15%)</th>
                  <th>Penguasaan Materi (30%)</th>
                  <th>Motivasi (15%)</th>
                  <th>Kemampuan Komunikasi</th>
                  <th>Laporan (tata tulis dan tata bahasa) (35%)</th>
                  <th>Produk (selaras dengan rancangan dan tujuan) (40%)</th>
                  <th>Luaran lain (artikel, poster, dsb.) (25%)</th>
                </tr>
              </thead>
               <tbody>
                <?php
                    ...
                    $id = $_SESSION['id_user'];
                    $sql  = $conn->query("SELECT * FROM `tb_penilaian_ta2`");
                    $no = 1;
