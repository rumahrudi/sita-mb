        ...
        <div class="row" style="margin-top:10px;">
          <div class="col-md-8">
             <div style="margin-bottom:5px;padding:5px 10px;background-color: #FDFDFD !important;border-radius:3px;">
                        <small style="font-weight:bold;color:#3c8dbc;font-size:13px;">Menu Tata Usaha</small>
                    </div>
                                         <div class="btn-group btn-group-justified">
                                                <a href="index.php?page=list_berkas_final" class="btn btn-menu" style="white-space: normal"><img src="img/file.png" class="icon-menu" alt="Pulsa" style="margin-bottom:7px; white-space: normal"><br> Verifikasi Berkas Final TA</a>
                                                <a href="index.php?page=data_sidang_tu" class="btn btn-menu" style="white-space: normal"><img src="img/file.png" class="icon-menu" alt="Pulsa" style="margin-bottom:7px; white-space: normal"><br> Data Sidang</a>
                                                <a href="" class="btn btn-menu" style="white-space: normal"><img src="img/coming-soon.png" class="icon-menu" alt="Pulsa" style="margin-bottom:7px;"></a>
