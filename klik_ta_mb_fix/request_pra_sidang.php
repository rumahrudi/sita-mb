  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <div class="row ">
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Request Pra Sidang Tugas Akhir</h3>
                    <a href="" class="btn-loading label label-primary pull-right" style="font-size: 13px;padding-bottom: 5px;padding-top: 5px; margin-right: 5px;" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus" style="margin-right: 3px;"></i> Request</a>
                </div><!-- /.box-header -->
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Request Pra Sidang TA2</h4>
      </div>
      <div class="modal-body">
        <form class="form-horizontal" role="form" action="proses_ta.php?aksi=request_approval_prasidang" method="post" enctype="multipart/form-data">
                  <input type="hidden" id="token" name="token" value="<?php echo $token; ?>">
                  ...
                  <div class="form-group">
                   <label  class="col-sm-2 control-label" for="inputEmail3">Request Tanggal Pra Sidang</label>
                   <div class="col-sm-10">
                   <input type="date"  id="tgl_prasidang" name="tgl_prasidang" class="form-control" required>
                    </div>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Upload Draft Laporan TA2</label>
                  <div class="col-sm-10">
                  ...
                  <p class="help-block">Silahkan unggah isi laporan  dalam bentuk PDF dan < 10MB</p>
                </div>
                </div>
                <div class="form-group">
                    <label  class="col-sm-2 control-label" for="inputEmail3">Link Demo Aplikasi</label>
                    <div class="col-sm-10">
                       <input type="text"  id="link_demo" name="link_demo" class="form-control" placeholder="ex: https://www.youtube.com/watch?v=6TEK1EDMGbc" required>
                    </div>
                  </div>
                  <div class="form-group">
          ...
          <thead>
                <tr>
                 <th>No</th>
                  ...
                  <th>Draft Laporan TA2</th>
                  <th>Link Demo Aplikasi</th>
                  <th>Status</th>
                  <th width="10%">#</th>
                </tr>
              </thead>
              <tbody>
                <?php
                    ...
                    error_reporting(E_ALL ^ (E_NOTICE | E_WARNING));
                    $id = $_SESSION['id_user'];
                    $sql  = $conn->query("SELECT * FROM `tb_pra_sidang` WHERE `id_mhs` = '$id'");
                    $no = 1;
                      while($data = mysqli_fetch_assoc($sql)){
                        ...
                        echo '<td >'.$data['tgl_pra_sidang'].'</td>';
                        echo '<td ><a class="btn btn-primary btn-xs" href="viewer.php?file='.base64_encode($data['draft_dokumen']).'" target="_blank"  role="button">Lihat File</a></td>';
                        echo '<td ><a class="btn btn-primary btn-xs" data-toggle="modal" href="'.$data['demo_aplikasi'].'" target="_blank" role="button">Lihat Demo</a></td>';
                        //echo '<td >'.$data['status'].'</td>';
                            if($data['status'] == 'Diajukan'){
                            echo '<td><span class="label label-default">Diajukan</span></td>';
                            echo '<td><a class="btn btn-default btn-xs" data-toggle="modal" data-target="#myModalEditt"  role="button">Diajukan</a></td>';
                            }
                            ...
                            echo '<td><a class="btn btn-danger btn-xs" data-toggle="modal" data-target="'.$nama_modal.''.$id_laporan.'"  role="button">Ditolak</a></td>';
                         ...
                         echo '<div id="myModalUpdate'.$id_laporan.'" class="modal fade" role="dialog" >
                          <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                              <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                <h4 class="modal-title">Request Pra Sidang</h4>
                              </div>
                              <div class="modal-body">
                              <p>Ajukan Prasidang yang baru kembali, karena pra sidang yang kamu ajukan telah ditolak pembimbing.
                              </div>
                              <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                              </div>
                          ...
                          <div class="modal-dialog modal-lg">
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body" style="height: 600px">
                                <iframe src="viewer.php?file='.base64_encode($data['draft_dokumen']).'" frameborder="0" width="100%" height="100%" allowtransparency="true"></iframe> 
                              </div>
                              <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                              </div>
