            ...
            <div class="box box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title" style="font-weight:bold;font-size:14px;text-transform:uppercase;">
                        ...
                        Penilaian Sidang Tugas Akhir untuk Anggota TA
                    </h3>
                </div>
                <div class="box-body">
                <?php
                ...
                $id_mhs = mysqli_real_escape_string($conn,$_GET['id_anggota']);
                ...
                $sql6  = $conn->query("SELECT * FROM `tb_laporan_ta` WHERE `id_mhs` = $id_ta ;");
                $data6 = mysqli_fetch_assoc($sql6);
                $file1 = $data6['file_laporan'];
                ?>
                    <form role="form" class="form-horizontal" action="proses_ta.php?aksi=penilaian_sidang_anggota" method="post" onsubmit="return confirm('Anda akan memberikan penilaian terhadap sidang, Periksa kembali nilai yang anda berikan, apabila anda sudah yakin, lanjutkan?');">
                       ...
                       <input type="hidden" id="id_ta" name="id_ta" value="<?php echo $id_ta; ?>">
                       ...
                       <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                  <input type="text" name="anggota" id="anggota" class="form-control" value="<?php echo base64_decode($_GET['nama']); ?>" readonly>
                                </div>
                            </div>
                             <div class="form-group">
