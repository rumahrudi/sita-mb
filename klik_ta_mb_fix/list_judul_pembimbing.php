        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Judul dan Pembimbing Mahasiswa</h3>
                    <a href="export_list_judul_pembimbing.php" class="btn-loading label label-success pull-right" style="font-size: 13px;padding-bottom: 5px;padding-top: 5px;" ><i class="fa fa-file-excel-o" style="margin-right: 3px;"></i> Export</a>
                </div><!-- /.box-header -->
                      ...
                      while($data = mysqli_fetch_assoc($sql)){
                        ...
                        echo '<td >
                         <div class="btn-group">
                              ...
                              <li>
                                <a href="proses_ta.php?token='.$token.'&aksi=ubah_status_sidang&status=Lulus&id_ta='.$id_ta.'" id="custId">Lulus</a>
                                </li>
                                <li>
                                <a href="proses_ta.php?token='.$token.'&aksi=ubah_status_sidang&status=TA 2&id_ta='.$id_ta.'" id="custId">TA 2</a>
                                </li>
                               <li>
                                <a href="proses_ta.php?token='.$token.'&aksi=ubah_status_sidang&status=TA 1&id_ta='.$id_ta.'" id="custId">TA 1</a>
                                </li>
                                <li>
                                <a href="proses_ta.php?token='.$token.'&aksi=ubah_status_sidang&status=Proposal&id_ta='.$id_ta.'" id="custId">Proposal</a>
                                </li>
                              </ul>
                        </div>
                        </td>';
