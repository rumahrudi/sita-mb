                ...
                $no=1;
                     $sql = $conn->query("SELECT * FROM `tb_jadwal_sidang` WHERE periode_sidang = '$periode'");
                      while($data = mysqli_fetch_assoc($sql)){
                        ...
                        echo '<td >';
                        echo ''.$data2['judul'].'';
                        echo ' <a class="btn btn-default btn-xs" href="" role="button"><i class="fa fa-eye"></i> detail</a> <a class="btn btn-default btn-xs" href="viewer.php?file='.base64_encode($data6['file_laporan']).'" role="button" target="_blank"><i class="fa fa-file"></i> laporan</a> <a class="btn btn-default btn-xs" href="viewer.php?file='.base64_encode($data['file_prasidang']).'" role="button" target="_blank"><i class="fa fa-file"></i> file pendukung</a>';
                        if($jenis_sidang == "Sidang TA 2 / Sidang 2 TANPA sidang magang"){
                          echo ' <a class="btn btn-default btn-xs" href="#myModalPrasidang" id="custId" data-toggle="modal" data-id="'.$data['id_pra_sidang'].'" role="button" ><i class="fa fa-edit"></i> Prasidang</a>';
                        }
                        echo '</td>';
                        if($iddosen != 0){
                          echo '<td > <a class="btn btn-success btn-xs" href="#myModalUser" id="custId" data-toggle="modal" data-id="'.$data['id_jadwal'].'" role="button" ><i class="fa fa-edit"></i> Edit Jadwal</a>'; 
                          echo ' <a class="btn btn-danger btn-xs" onclick="return confirm(\'Anda akan menghapus data. Lanjutkan?\');" href="proses_ta.php?aksi=delete_laporan&id='.$idjadwal.'&periode='.$_GET['periode'].'" ><i class="fa fa-trash"></i></a></td>';  
                        }else{
                          echo '<td > <a class="btn btn-primary btn-xs" href="#myModalUser" id="custId" data-toggle="modal" data-id="'.$data['id_jadwal'].'" role="button" ><i class="fa fa-check"></i> Set Jadwal</a>';   
                          echo ' <a class="btn btn-danger btn-xs" onclick="return confirm(\'Anda akan menghapus data. Lanjutkan?\');" href="proses_ta.php?aksi=delete_jadwal&id='.$idjadwal.'&periode='.$_GET['periode'].'" ><i class="fa fa-trash"></i></a></td>'; 
                        }
