  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <div class="box box-widget" style="margin-bottom: 10px;background-color: #FDFDFD">
                                <div class="alert alert-warning alert-dismissible">
                                  ...
                                  Pastikan seluruh dokumen telah diperiksa kebenaran dan kelengkapannya. Jika ada dokumen yang tidak lengkap, maka dosen pembimbing akan dimintai pertanggungjawaban untuk melengkapi
                                </div>
                                </div>
          ...
          <thead>
               ...
               <tbody>
                <?php
                    ...
                    $sql  = $conn->query("SELECT * FROM `tb_berkas_final` WHERE id_mhs IN (SELECT id_mhs FROM `tb_tugas_akhir` WHERE id_dosen = $id);");
                    $no = 1;
