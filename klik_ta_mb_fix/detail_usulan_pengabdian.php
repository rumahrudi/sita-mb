...
if(($_SESSION['user_role'] != "dosen") AND ($_SESSION['user_role'] != "staffp3m") AND ($_SESSION['user_role'] != "ketuap3m") AND ($_SESSION['user_role'] != "laboran")){
                  echo '<script language="javascript">alert("Anda tidak dapat melihat halaman ini");history.back();</script>';
}
...
<head>
  ...
  <title>SIMP3M | List Usulan Pengabdian</title>
  <!-- Favicon -->
...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <!-- /.sidebar -->
                ...
                $sql3="SELECT * FROM tb_usulan_pengabdian WHERE `id_usulan` = '".$id_usulan."' ";
                ...
                $sql5="SELECT * FROM tb_jurusan WHERE `id_jur` = '".$id_jur."' ";
                $result5 = $conn->query($sql5);
                $row5 = mysqli_fetch_array($result5);
                $nama_jurusan = $row5['nama_jurusan'];
                $kode_jurusan = $row5['kode_jurusan'];
    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-file"></i> Usulan Proposal Pengabdian.
      ...
      <div class="row invoice-info">
        <div class="col-sm-6 invoice-col">
          <h4>Identitas Pengabdian</h4>
          <dl class="dl-horizontal">
                <dt style="text-align: left;">Judul Pengabdian</dt>
        ...
        <div class="col-sm-6 invoice-col">
          ...
          <dl class="dl-horizontal">
                ...
                <dt style="text-align: left;">Jurusan</dt>
                <dd><?php echo $kode_jurusan; echo ' - '; echo $nama_jurusan; ?></dd>
              </dl>
        </div>
        ...
        <div class="col-xs-12 table-responsive">
          ...
          <table class="table table-striped">
            ...
            <?php
                    include 'config.php';
                    error_reporting(E_ALL ^ (E_NOTICE | E_WARNING));
                    $sql_tim  = $conn->query("SELECT * FROM `tb_anggota_usulan_pengabdian` WHERE id_usulan = '$id_usulan'");
                    $no = 1;
      ...
      <div class="row">
        <div class="col-xs-12 table-responsive">
          <h4>Anggota Pengabdian Mahasiswa</h4>
          <table class="table table-striped">
            <thead>
            <tr>
              <th>No</th>
            ...
            <?php
                    include 'config.php';
                    error_reporting(E_ALL ^ (E_NOTICE | E_WARNING));
                    $sql_tim  = $conn->query("SELECT * FROM `tb_anggota_mhs_usulan_pengabdian` WHERE id_usulan = '$id_usulan'");
                    $no = 1;
                      while($data_tim = mysqli_fetch_assoc($sql_tim)){
                        echo '<tr>';
                        echo '<td >'.$no.'</td>';
        ...
        <div class="col-xs-12 table-responsive">
          ...
          <table class="table table-striped">
            ...
            <?php
                    include 'config.php';
                    error_reporting(E_ALL ^ (E_NOTICE | E_WARNING));
                    $sql_rab  = $conn->query("SELECT * FROM `tb_rab_usulan_pengabdian` WHERE id_usulan = '$id_usulan' AND jenis_pengeluaran = 'Honor'");
                    $no = 1;
              ...
              <?php
                    include 'config.php';
                    error_reporting(E_ALL ^ (E_NOTICE | E_WARNING));
                    $sql_ra3  = $conn->query("SELECT * FROM `tb_rab_usulan_pengabdian` WHERE id_usulan = '$id_usulan' AND jenis_pengeluaran = 'Bahan habis pakai'");
              ...
              <?php
                    include 'config.php';
                    error_reporting(E_ALL ^ (E_NOTICE | E_WARNING));
                    $sql_rab2  = $conn->query("SELECT * FROM `tb_rab_usulan_pengabdian` WHERE id_usulan = '$id_usulan' AND jenis_pengeluaran = 'Perjalanan'");
              ...
              <?php
                    include 'config.php';
                    error_reporting(E_ALL ^ (E_NOTICE | E_WARNING));
                    $sql_rab4 = $conn->query("SELECT * FROM `tb_rab_usulan_pengabdian` WHERE id_usulan = '$id_usulan' AND jenis_pengeluaran = 'Lain-lain'");
      ...
      <div class="row invoice-info no-print">
        <div class="col-sm-12 invoice-col">
          <h4>Subtansi Proposal Pengabdian</h4>
          <?php
          include 'config.php';
          error_reporting(E_ALL ^ (E_NOTICE | E_WARNING));
          ...
          ?>
          <p class="text-muted well well-sm no-shadow" style="margin-top: 10px;">
            Klik link berikut untuk melihat Proposal Pengabdian <a target="_blank" class="btn btn-default btn-xs" href="viewer.php?file=<?php echo $file1; ?>" role="button"><i class="fa fa-eye"></i> Lihat</a>
          </p>
        </div>
      </div>
      <div class="row invoice-info no-print">
      ...
      <div class="row invoice-info no-print">
        <div class="col-sm-12 invoice-col">
          ...
          <p class="text-muted well well-sm no-shadow" style="margin-top: 10px;">
            Klik link berikut untuk meng-unduh semua file tersedia <a target="_blank" class="btn btn-default btn-xs" href="view2.php?id_usulan=<?php echo $id_usulan ?>" role="button"><i class="fa fa-download"></i> Unduh</a>
          </p>
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          <a target="_blank" class="btn btn-primary" href="cetak_usulan2.php?id_usulan=<?php echo base64_encode($id_usulan); ?>" role="button"><i class="fa fa-print"></i> Print</a>
        </div>
      </div>
    </section>
    <!-- /.content -->
