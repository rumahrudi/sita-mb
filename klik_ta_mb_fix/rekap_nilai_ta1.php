...
<head>
  ...
  <title>SITA | Rekap Nilai Bimbingan</title>
  <!-- Favicon -->
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                  <a href="index.php?page=admin" class="btn-loading"><i class="fa fa-arrow-left" style="margin-right:10px;"></i></a>
                    <h3 class="box-title">Rekap Nilai Bimbingan TA1</h3>
                    <a href="index.php?page=export_rekap_nilai_ta1" class="btn-loading label label-primary pull-right" style="font-size: 13px;padding-bottom: 5px;padding-top: 5px;" ><i class="fa fa-file-excel-o" style="margin-right: 3px;"></i> Export</a>
                </div><!-- /.box-header -->             
