                ...
                <?php
                    ...
                    $no = 1;
                      while($data = mysqli_fetch_assoc($sql)){
                        ...
                        $sql3  = $conn->query("SELECT *, DATE_FORMAT(`tanggal_sidang`, '%D %M %Y') as `tanggal` FROM `tb_jadwal_sidang` WHERE id_tugas_akhir = '$id_mhs' AND jenis_sidang = 'Sidang TA 1 / Sidang 1' ORDER BY id_jadwal DESC LIMIT 1;");
                        ...
                        $sql4  = $conn->query("SELECT *, DATE_FORMAT(`tanggal_sidang`, '%D %M %Y') as `tanggal` FROM `tb_jadwal_sidang` WHERE id_tugas_akhir = '$id_mhs' AND jenis_sidang = 'Sidang TA 2 / Sidang 2 TANPA sidang magang' ORDER BY id_jadwal DESC LIMIT 1;");
                        ...
                        $komentar_ta2 = $data8['catatan_perbaikan'];
                        $sidang_ulang_ta2 = $data8['sidang_ulang'];
                        ...
                        $komentar_ta2_2 = $data9['catatan_perbaikan'];
                        $sidang_ulang_ta2_2 = $data9['sidang_ulang'];
                       ...
                       // if($jenis_sidang == 'Sidang TA 1 / Sidang 1'){
                          echo '<td>';
                          if(empty($data10)){
                            echo '<a class="btn btn-primary btn-xs" href="index.php?page=nilai_ta1&id_ta='.base64_encode($id_mhs).'"><i class="fa fa-check"></i> Beri Nilai TA1</a> ';
                          }
                          else{
                            echo '<a class="btn btn-success btn-xs" href="index.php?page=nilai_ta1&id_ta='.base64_encode($id_mhs).'"><i class="fa fa-edit"></i> Edit Nilai TA1</a>';
                          }

                          if(empty($data11)){
                            echo '&nbsp;<a class="btn btn-primary btn-xs" href="index.php?page=nilai_ta2&id_ta='.base64_encode($id_mhs).'"><i class="fa fa-check"></i> Beri Nilai TA2</a> ';
                          }
                          else{
                            echo '&nbsp;<a class="btn btn-success btn-xs" href="index.php?page=nilai_ta2&id_ta='.base64_encode($id_mhs).'"><i class="fa fa-edit"></i> Edit Nilai TA2</a>';
                          }
...
<div class="row ">
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">List Mahasiswa Bimbingan sebagai Anggota TA</h3>
          ...
          <thead>
               ...
               <tbody>
                <?php
                    ...
                    error_reporting(E_ALL ^ (E_NOTICE | E_WARNING));
                    $id = $_SESSION['id_user'];
                    $sql  = $conn->query("SELECT * FROM `tb_anggota_tugas_akhir` WHERE `id_tugas_akhir` IN (SELECT id_mhs FROM tb_tugas_akhir WHERE id_dosen = $id)");
                    $no = 1;
                      while($data = mysqli_fetch_assoc($sql)){
                        $idmhs = $data['id_mhs'];
                        $id_tugasa = $data['id_tugas_akhir'];

                        $sql1  = $conn->query("SELECT * FROM `tb_tugas_akhir` WHERE id_mhs = $id_tugasa");
                        $data1 = mysqli_fetch_assoc($sql1);

                        $sql2  = $conn->query("SELECT * FROM `tb_user_mhs` WHERE id_user_mhs = $idmhs");
                        $data2 = mysqli_fetch_assoc($sql2);
                        $id_mhs = $data['id_mhs'];

                        $sql3  = $conn->query("SELECT *, DATE_FORMAT(`tanggal_sidang`, '%D %M %Y') as `tanggal` FROM `tb_jadwal_sidang` WHERE id_tugas_akhir = '$id_tugasa' AND jenis_sidang = 'Sidang TA 1 / Sidang 1' ORDER BY id_jadwal DESC LIMIT 1;");
                        $data3 = mysqli_fetch_assoc($sql3);
                        ...
                        $sql4  = $conn->query("SELECT *, DATE_FORMAT(`tanggal_sidang`, '%D %M %Y') as `tanggal` FROM `tb_jadwal_sidang` WHERE id_tugas_akhir = '$id_tugasa' AND jenis_sidang = 'Sidang TA 2 / Sidang 2 TANPA sidang magang' ORDER BY id_jadwal DESC LIMIT 1;");
                        $data4 = mysqli_fetch_assoc($sql4);
                        ...
                        //if($jenis_sidang == 'Sidang TA 1 / Sidang 1'){
                          echo '<td>';
                          if(empty($data10)){
                            echo '<a class="btn btn-primary btn-xs" href="index.php?page=nilai_ta1_a&id_ta='.base64_encode($id_tugasa).'&id_mhs='.$idmhs.'"><i class="fa fa-check"></i> Beri Nilai TA1</a> ';
                          }
                          else{
                            echo '<a class="btn btn-success btn-xs" href="index.php?page=nilai_ta1_a&id_ta='.base64_encode($id_tugasa).'&id_mhs='.$idmhs.'"><i class="fa fa-edit"></i> Edit Nilai TA1</a>';
                          }

                          if(empty($data11)){
                            echo '&nbsp;<a class="btn btn-primary btn-xs" href="index.php?page=nilai_ta2_a&id_ta='.base64_encode($id_tugasa).'&id_mhs='.$idmhs.'"><i class="fa fa-check"></i> Beri Nilai TA2</a> ';
                          }
                          else{
                            echo '&nbsp;<a class="btn btn-success btn-xs" href="index.php?page=nilai_ta2_a&id_ta='.base64_encode($id_tugasa).'&id_mhs='.$idmhs.'"><i class="fa fa-edit"></i> Edit Nilai TA2</a>';
                          }
