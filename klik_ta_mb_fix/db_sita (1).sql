...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 28 Jul 2020 pada 06.59
...
CREATE TABLE `tb_jadwal_sidang` (
  ...
  `file_magang` varchar(250) NOT NULL,
...
--
-- Dumping data untuk tabel `tb_jadwal_sidang`
--

INSERT INTO `tb_jadwal_sidang` (`id_jadwal`, `periode_sidang`, `jenis_sidang`, `id_tugas_akhir`, `file_laporan`, `file_prasidang`, `file_magang`, `penguji_1`, `penguji_2`, `tanggal_sidang`, `jam_sidang`) VALUES
(24, 'Agustus 2020', 'Sidang TA 2 / Sidang 2 DENGAN sidang magang', 12, 'uploads/tugas_akhir/3411911053/12_laporan_Agustus2020_3411911053.pdf', 'uploads/tugas_akhir/3411911053/12_prasidang_Agustus2020_3411911053.pdf', 'uploads/tugas_akhir/3411911053/12_laporanmagang_Agustus2020_3411911053.pdf', 1, 7, '2020-07-31', '13.00 - 14.00 WIB'),
(25, 'Agustus 2020', 'Sidang Proposal', 44, '-', '-', '-', 5, 6, '2020-07-29', '13.00 - 14.00 WIB');
...
(44, 1, 'Aplikasi perpajakan', 'Aplikasi untuk pajak', 'Proposal'),
(45, 1, '-', '-', 'Proposal'),
(46, 1, '-', '-', 'Proposal'),
(73, 1, '-', '-', 'Proposal');
