...
<div class="row">
        <div class="col-md-12">
            <div class="box box-solid">
                ...
                $sql10  = $conn->query("SELECT * FROM `tb_penilaian_ta1` WHERE id_mhs = '$id_ta' AND id_dosen = '$id';");
                ...
                if(empty($data10)){
                  echo '
                  <form role="form" class="form-horizontal" action="proses_ta.php?aksi=penilaian_ta1" method="post" onsubmit="return confirm("Anda akan memberikan penilaian TA1 terhadap mahasiswa bimbingan anda, Periksa kembali nilai yang anda berikan, apabila anda sudah yakin, lanjutkan?");">
                                ...
                                <div class="col-sm-9">
                                   <table class="table table-striped">
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        <td>2</td>
                                        <td>Kedalaman Analisis / Perancangan (35%)
                                        </td>
                                        <td>Nilai 7-10</td>
                  ...
                  echo '
                  <form role="form" class="form-horizontal" action="proses_ta.php?aksi=update_penilaian_ta1" method="post" onsubmit="return confirm("Anda akan mengubah penilaian TA1 terhadap mahasiswa bimbingan anda, Periksa kembali nilai yang anda berikan, apabila anda sudah yakin, lanjutkan?");">
                       <input type="hidden" id="token" name="token" value="'.$token.'">
                       <input type="hidden" id="id_mhs" name="id_mhs" value="'.$id_ta.'">
                       <div class="box-body">
                            <div class="form-group">
