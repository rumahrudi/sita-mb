...
<head>
  ...
  <title>SITA | Rekap Nilai Bimbingan TA2</title>
  <!-- Favicon -->
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                  <a href="index.php?page=admin" class="btn-loading"><i class="fa fa-arrow-left" style="margin-right:10px;"></i></a>
                    <h3 class="box-title">Rekap Nilai Bimbingan TA2 <sup><span class="blink">NEW</span></sup></h3>
                    <a href="index.php?page=export_rekap_nilai_ta2_baru" class="btn-loading label label-primary pull-right" style="font-size: 13px;padding-bottom: 5px;padding-top: 5px;" ><i class="fa fa-file-excel-o" style="margin-right: 3px;"></i> Export</a>

                    <a href="index.php?page=rekap_nilai_ta2_lama" target="_blank" class="btn btn-success btn-xs pull-right" style="margin-right: 5px"><i class="fa fa-file"></i> Nilai Lama</a>&nbsp;
                </div><!-- /.box-header -->             
