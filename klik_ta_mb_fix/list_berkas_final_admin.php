          ...
          <thead>
               ...
               <tbody>
                <?php
                    ...
                    $sql  = $conn->query("SELECT * FROM `tb_berkas_final` WHERE status != 'Belum Lengkap';");
                    $no = 1;
                      while($data = mysqli_fetch_assoc($sql)){
                        ...
                        $sql3  = $conn->query("SELECT * FROM `tb_set_input_nilai` WHERE id_mhs = $id_mhs");
                        ...
                        if(empty($data3)){
                          ...
                          <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                  <li>
                                  <a href="proses_ta.php?token='.$token.'&aksi=set_nilai&status=Sudah&id_mhs='.base64_encode($id_mhs).'" id="custId">Sudah</a>
                                  </li>
                                 <li>
                                  <a href="proses_ta.php?token='.$token.'&aksi=set_nilai&status=Belum&id_mhs='.base64_encode($id_mhs).'" id="custId">Belum</a>
                                  </li>
                        ...
                        <div class="btn-group">
                              ...
                              <ul class="dropdown-menu">
                                <li>
                                <a href="proses_ta.php?token='.$token.'&aksi=update_set_nilai&status=Sudah&id_mhs='.base64_encode($id_mhs).'" id="custId">Sudah</a>
                                </li>
                               <li>
                                <a href="proses_ta.php?token='.$token.'&aksi=update_set_nilai&status=Belum&id_mhs='.base64_encode($id_mhs).'" id="custId">Belum</a>
                                </li>
    ...
    <table id="example" class="table table-bordered table-striped" data-page-length="25">
              <thead>
               ...
               <tbody>
                ...
                $no=1;
                     $sql = $conn->query("SELECT * FROM `tb_jadwal_sidang` WHERE jenis_sidang = 'Sidang TA 2 / Sidang 2 TANPA sidang magang'");
                      while($data = mysqli_fetch_assoc($sql)){
