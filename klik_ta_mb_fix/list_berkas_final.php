          ...
          <thead>
               ...
               <tbody>
                <?php
                    ...
                    $sql  = $conn->query("SELECT * FROM `tb_berkas_final`;");
                    $no = 1;
                      while($data = mysqli_fetch_assoc($sql)){
                        ...
                        echo '<td><a class="btn btn-primary btn-xs" href="index.php?page=verifikasi_berkas_final&id_mhs='.base64_encode($id_mhs).'"><i class="fa fa-eye"></i> Lihat Berkas</a></td>';
