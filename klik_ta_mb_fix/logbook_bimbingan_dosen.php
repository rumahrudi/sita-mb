...
<div class="wrapper">
  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <div class="box-body">
        <table id="load" class="table table-hover">
          <thead>
                <tr>
                 <th>No</th>
                  <th width="10%"><i class="fa fa-calendar"></i></th>
                  <th >Kegiatan</th>
                  <th width="10%">% Kemajuan TA</th>
               ...
               <tbody>
                <?php
                    ...
                    $id_mhs = $_GET['id_mhs'];
                    $sql  = $conn->query("SELECT * FROM `tb_logbook_ta` WHERE id_mhs= '$id_mhs'");
                    $no = 1;
    ...
    <div class="box-footer" align="left" style="padding-top:13px;">
      <p>
        Catatan:<br>
        Ingatkan Mahasiswa Untuk Isi logbook setiap minggu nya sesuai dengan hasil bimbingan. <br>
      </p>
    </div>
</div>
</section>
